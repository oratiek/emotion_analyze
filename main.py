...
class EmotionRecognition:
	...
	def recognition(self):
		...
		while True:
			...
			for x,y,w,h in faces:
				...
				saveData = np.append(prob, EMOTIONS[emotion])
				print(saveData)
	...
	def createVideo(self):
		...
		command = "ffmpeg -r 10 -i {}/%d.jpg -vcodec libx264 -pix_fmt yuv420p -r 60 {}".format(self.images_path, output_path)
		os.system(command)
...
if __name__ == "__main__":
	root = sys.argv[1]
	recognizer = EmotionRecognition(root)
	recognizer.prep()
